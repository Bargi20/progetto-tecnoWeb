...
class PublicController extends Controller
{
    ...
    public function showAllDottori(): View {
        $Doc = $this->_catalogModel->getAllDottori(); //i dati che servono sono i dati delle categorie top
    ...
    public function showFaq(): View {
        $faq = $this->_catalogModel->getfaq(); //i dati che servono sono i dati delle categorie top
        //attiva dell'oggetto che rappresenta il model il metodo del getTopCats
        return view('Faq')
                        ->with('faq', $faq); //prodotti in cascata dove alla vista catalog viene passati i valori che abbiamo estratto dal model
    }
